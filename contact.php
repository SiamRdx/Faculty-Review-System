...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="#3760ae">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Mohammadia Housing ltd.<br>Mohammadpur, Dhaka-1207, Bangladesh<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (+880) 179-1043351</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">siamkhan.cse@gmail.com</a>
                </p>
