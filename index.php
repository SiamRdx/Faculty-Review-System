...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#1461f1">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Online Faculty Review System</a>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/brac_convo.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/lead_720_405.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/fye6.jpg');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>About Faculty Review System</h2>
				Students' Feedback system for university faculties. 
Here we have developed the a faculty feedback system, which is generally used in the university to rate the faculty based on the performance.
We have 2 modules which are administrator and student.
...
If you entered the student user and password and selected student option, then it will show all student information and let you enter the feedback based on the subject..
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#707880">
		<span style="color:#FFFFFF">&#169 Siam Khan </span>
	</div>
    <!-- jQuery -->
